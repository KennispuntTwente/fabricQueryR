...
fields directly; its DAX and refresh methods reuse the
...
Client-side `timeout` in `$refresh_wait()` only bounds how long R
...
timeout in `$refresh_wait()` controls how long R waits. Use
