...
against Fabric. However, detailed User Data Function discovery and public
function invocation are not exercised by the standard live integration lane.
...
remove its own disposable public-function fixtures. The opt-in live invocation
tests instead require URLs for functions that a user has published manually.
Until repeatable end-to-end coverage is possible, treat these APIs and their
returned service shapes as subject to change.
