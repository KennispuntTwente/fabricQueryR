...
The caller needs Execute permission on the item. If sign-in succeeds but the
call is denied, ask the item owner or Fabric administrator to check item access
and the relevant tenant setting.
