...
removed in a future Spark release. Prefer PySpark or Spark SQL for new
workloads, and retain `"sparkr"` primarily for existing R-on-Spark code while
planning a migration.

| `kind` | Code language |
|---|---|
| `"sql"` | Spark SQL |
| `"sparkr"` | SparkR (deprecated upstream in Spark 4.x) |
