...
object, so its endpoint, workspace, and credential travel with its query,
schema, and pagination methods:
...
`$paginate()` marks a result complete only after the API reports
