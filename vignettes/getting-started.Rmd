...
A discovered item contains metadata such as its name and type. Pass that item
directly to other 'fabricQueryR' functions instead of copying IDs or connection
details by hand.
