...
- OneLake authentication guidance now distinguishes item `Read`
  ...
  access), and notes that fabricQueryR is not an authorized OneLake
  security engine: RLS/CLS- restricted direct file reads are blocked
  rather than policy-filtered.
