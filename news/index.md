...
- [`fabric_sql_query()`](https://kennispunttwente.github.io/fabricQueryR/reference/fabric_sql_query.md)
  now defaults to `numeric_policy = "exact"`. ODBC results with INT,
  BIGINT, DECIMAL, or NUMERIC columns are rejected under this policy.
  Use `backend = "adbc"` to preserve numeric precision, or explicitly
  set `numeric_policy = "driver"` to accept the ODBC driver’s
  conversions.
...
- [`fabric_sql_connect()`](https://kennispunttwente.github.io/fabricQueryR/reference/fabric_sql_connect.md)
  ...
  parameters, and Arrow streams for larger results.
