...
* The internal Fabric long-running-operation poller now honors `Retry-After`,
  shares one deadline across requests and sleeps, returns structured timeout
  context, and follows a successful operation's result location.
