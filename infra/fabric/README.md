...
this externally provisioned group locally, but fail the dedicated User Data
Function CI lane so it cannot pass without making live calls. The offline suite
always covers disabled public access, service and client timeouts, oversized
responses, structured user errors, and metadata/error redaction while
preserving function output.
