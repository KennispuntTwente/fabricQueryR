...
You need a Fabric workspace on supported capacity and a Lakehouse with a
Livy endpoint. The signed-in account must be allowed to read and execute
the Lakehouse and access the data used by the code.
