...
precomposed `caf\u00e9` but rejected decomposed `e\u0301` and connector
punctuation in `x\u203fy` in the Fabric sandbox on 7 September 2026.
This conflicts with the [documented Unicode
categories](https://learn.microsoft.com/en-us/fabric/data-engineering/troubleshoot-lakehouse#delta-table-schema-errors).
The package rejects those names before staging; explicitly normalize or
rename them in your data if necessary.
