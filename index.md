...
inspect the structured result. This API is experimental; its service
shapes may change. See the vignette for the current validation limits.
...
copied into the current Lakehouse.
