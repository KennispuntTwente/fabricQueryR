...
It comes with discovery helpers and seven methods which help you to work with Microsoft Fabric data from R:
...
Below is a code snippet showing how to discover targets and use the seven methods to work with Fabric data from R:
