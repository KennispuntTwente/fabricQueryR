...
It comes with discovery helpers and six methods which help you to get your Microsoft Fabric data into R:
...
Below is a code snippet showing how to discover targets and use the six methods to get data from Fabric into R:
