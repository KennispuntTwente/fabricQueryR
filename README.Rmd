...
It comes with discovery helpers and eight methods which help you to work with Microsoft Fabric data from R:
...
5. Execute a Livy API query: `fabric_livy_query()`.
